...
public class PartidosConverter implements Converter {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        return partidosModel.obtenerPartido(value);
    }
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        ...
        if(value instanceof PartidosEntity){
            return ((PartidosEntity) value).getCodigoPartido();
        }
        return "";
    }
    ...
    private PartidosModel lookupPartidosModelBean() {
        try {
            ...
            return (PartidosModel) c.lookup("java:global/ProyectoPooPeriodo2/PartidosModel!sv.edu.udb.www.model.PartidosModel");
